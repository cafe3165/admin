...
public class register3_2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(register3_2Activity.this,register2_2Activity.class);
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(pw.getText().toString())&&!TextUtils.isEmpty(pwcon.getText().toString())){
                    if (pw.getText().toString().equals(pwcon.getText().toString())){
                        ...
                        asper.setPerAcPermission_1(bundle1.getString("college"));
                        asper.setPerImPermission_1(bundle1.getString("college"));
                        asper.setPerImPermission_2(bundle1.getString("grade"));
                        asper.setPerAcPermission_2(bundle1.getString("grade"));
                        ...
                        asper.save(new SaveListener<String>() {
                            ...
                            public void done(String s, BmobException e) {
                                if (e==null){
                                    Toast.makeText(register3_2Activity.this,"申请提交成功，等待管理员审核",Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(register3_2Activity.this,loginRegisterActivity.class);
                                    startActivity(intent);
                                }
                                else{
                                    Toast.makeText(register3_2Activity.this,"申请提交失败",Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                    else{
                        Toast.makeText(register3_2Activity.this,"密码不一致",Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    Toast.makeText(register3_2Activity.this,"输入不能为空",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
