...
//        });
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //声明已发布的活动列表查询需要的变量
            final ListView lv_activity;
            final ActivityAdapter[] mAdapter = new ActivityAdapter[1];
            final List<AsActivity> asActivityList = new ArrayList<AsActivity>();

            lv_activity = (ListView) rootView.findViewById(R.id.lv_activity);
            ...
            bmobQuery.findObjects(new FindListener<AsActivity>() {
                ...
                public void done(List<AsActivity> list, BmobException e) {
                    ...
                    if (e == null) {
                        ...
                        mAdapter[0] = new ActivityAdapter(getActivity(),asActivityList);

                        lv_activity.setAdapter(mAdapter[0]);
                    }
                }
            });
            return rootView;
