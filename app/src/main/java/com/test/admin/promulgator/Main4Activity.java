...
//        });
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //声明已结束的活动列表查询需要的变量
            final ListView lv_imformation;
            final ImformationAdapter[] mAdapter = new ImformationAdapter[1];
            final List<AsImformation> asImformationsList = new ArrayList<AsImformation>();

            lv_imformation = (ListView) rootView.findViewById(R.id.lv_imformation);

            BmobQuery<AsImformation> bmobQuery = new BmobQuery<AsImformation>();
            bmobQuery.addQueryKeys("imTitle,imContent");
            bmobQuery.findObjects(new FindListener<AsImformation>() {
                ...
                public void done(List<AsImformation> list, BmobException e) {
                    ...
                    if (e == null) {
                        ...
                        mAdapter[0] = new ImformationAdapter(getActivity(),asImformationsList);

                        lv_imformation.setAdapter(mAdapter[0]);
                    }
                }
            });
